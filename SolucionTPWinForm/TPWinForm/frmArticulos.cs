...
namespace TPWinForm
{
    public partial class frmArticulos : Form
    {
        ...
        private void btnSiguienteImagen_Click(object sender, EventArgs e)
        {
            ...
            {
                indiceImagenActual = (indiceImagenActual + 1) % seleccionado.Imagenes.Count; // Avanza circularmente
                cargarImagen(seleccionado.Imagenes[indiceImagenActual].ImagenUrl);
            }
        }
        ...
        private void btnImagenAnterior_Click(object sender, EventArgs e)
        {
            ...
            if (seleccionado != null && seleccionado.Imagenes.Count > 0)
            {
                indiceImagenActual = (indiceImagenActual - 1 + seleccionado.Imagenes.Count) % seleccionado.Imagenes.Count; // Retrocede circularmente
                cargarImagen(seleccionado.Imagenes[indiceImagenActual].ImagenUrl);
            }
        }
